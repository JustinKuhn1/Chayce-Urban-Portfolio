    ...
    <>
      <header
        className={`fixed top-2 sm:top-4 left-1/2 -translate-x-1/2
          ...
          ${scrolled ? 'py-2' : 'py-4'}
          bg-white/80 dark:bg-gray-900/80 backdrop-blur-md text-gray-800 dark:text-gray-100 rounded-full
        `}
      >
        ...
        {isOpen && (
          <motion.div
            ...
            className="md:hidden absolute left-0 top-full mt-2 w-full py-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-b-full shadow-lg"
          >
